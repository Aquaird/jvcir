...
class opts():
  ...
  def init(self):
    ...
    self.parser.add_argument('-trainBatch', type = int, default = 12, help = 'Mini-batch size')
    ...
    self.parser.add_argument('-trainRES', type = int, default = 0, help = 'train regression with only h36m')
